...
public class About extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSiteUrl = findPreference("pa_website");
        mForumUrl = findPreference("pa_forum");
        mSourceUrl = findPreference("pa_source");
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mSiteUrl) {
            launchUrl("http://paranoid-rom.com/");
        } else if (preference == mForumUrl) {
            launchUrl("http://www.paranoid-rom.com/forum/");
        } else if (preference == mSourceUrl) {
            launchUrl("http://github.com/ParanoidAndroid");
        }
